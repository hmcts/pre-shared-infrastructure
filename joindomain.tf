...
resource "azurerm_virtual_machine_extension" "vm_aad" {
  ...
  virtual_machine_id         = concat([azurerm_windows_virtual_machine.vm.*.name,azurerm_windows_virtual_machine.dtgtwyvm.*.name]) #azurerm_windows_virtual_machine.vm.*.id[count.index]
