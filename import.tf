import {
  to = module.data_store_db_v14.azurerm_postgresql_flexible_server_database["pre-pdb-stg"]
...
import {
  to = module.data_store_db_v14.azurerm_postgresql_flexible_server_database["api"]
...
import {
  to = module.data_store_db_v14.azurerm_postgresql_flexible_server_active_directory_administrator[0]
