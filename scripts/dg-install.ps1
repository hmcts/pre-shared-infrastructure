...
Install-Package -ProviderName NuGet -Name NuGet.CommandLine -Force
...
$installedVersion = & $pwshPath --version

Write-Host "PowerShell 7 has been installed. Version: $installedVersion"
